...
/obj/item/robot_model/syndicatejack
	...
	basic_modules = list(
		...
		// /obj/item/borg_shapeshifter, //not currently porting this - Missfox to fix later (Its under modularSR shapeshifting_module)
		)
...
/obj/item/robot_model/syndicatejack/be_transformed_to(obj/item/robot_model/old_model)
	...
	var/static/list/syndicatejack_icons = sortList(list(
		...
		"Heavy" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "syndieheavy"),
		"Miss m" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "missm_syndie"),
		"Spider" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "spidersyndi"),
		"Booty Striker" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "bootynukie"),
		"Booty Syndicate" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "bootysyndie"),
		"Male Booty Striker" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "male_bootynukie"),
		"Male Booty Syndicate" = image(icon = 'code/modules/mob/living/silicon/robot/altborgs/icons/mob/robots.dmi', icon_state = "male_bootysyndie"),
		))
